...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,hsl(280_70%_75%/0.1)_0%,transparent_50%)] animate-glow-pulse" />
      <div className="absolute top-20 right-20 w-96 h-96 bg-[radial-gradient(circle,hsl(270_70%_60%/0.15)_0%,transparent_70%)] blur-3xl animate-float" />
      <div className="absolute bottom-20 left-20 w-96 h-96 bg-[radial-gradient(circle,hsl(280_70%_75%/0.15)_0%,transparent_70%)] blur-3xl animate-float" style={{ animationDelay: "3s" }} />
